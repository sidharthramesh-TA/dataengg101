...
csv_file_path = '/home/sid/Desktop/dataengg101/data/sales.csv'
table_name = 'landing_sales'
...
df.to_sql(table_name, engine, if_exists='append', index=False)  # Use 'append' to add data to an existing table
